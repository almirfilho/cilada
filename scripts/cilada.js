...
(function() {
  var $canvas, Ball, Hole, Wall, audio, b2Body, b2BodyDef, b2CircleShape, b2ContactListener, b2DebugDraw, b2Fixture, b2FixtureDef, b2PolygonShape, b2Vec2, b2World, ball, bodyDef, config, contact, ctx, endGame, fixDef, game, holes, init, loadSounds, update, walls, world;
  ...
  loadSounds = function() {
    ...
    request.onload = function() {
      return audio.decodeAudioData(request.response, function(buffer) {
        ...
        return alert('erro ao ler audio 1');
      });
    };
    request.send();
    ...
    request2.onload = function() {
      return audio.decodeAudioData(request2.response, function(buffer) {
        return ball.dieBuffer = buffer;
      }, function() {
        return alert('erro ao ler audio 2');
      });
    };
